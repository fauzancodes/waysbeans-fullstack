...
func CartRoutes(e *echo.Group) {
	...
	e.PATCH("/increase-order-quantity/:product_id", middleware.Auth(h.IncreaseOrderQuntity))
	e.PATCH("/decrease-order-quantity/:product_id", middleware.Auth(h.DecreaseOrderQuntity))
}
