                ...
                props.isAdmin === false ? (
                  <>
                    <div onClick={() => navigate("/cart")} style={{ cursor:"pointer" }} className="position-relative d-inline">
                      <img src="/images/icon-cart.webp" alt="Cart" className={`me-5 ${props.darkMode && "p-2"} ${props.darkMode && "rounded-circle"}`} style={{ backgroundColor: props.darkMode ? "#F6E6DA" : "transparent" }}/>
                      {
