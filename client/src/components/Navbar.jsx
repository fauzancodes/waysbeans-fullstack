                  ...
                  <>
                    ...
                    <Dropdown className="d-inline">
                      <Dropdown.Toggle id="profile-menu" className="border-0" style={{ backgroundColor:"transparent" }}>
                        {
                          props.Profiles.find(profile => profile.user_id === props.User.id)?.photo === "" ? (
                            <img src="/images/profile-picture-placeholder.webp" alt="Profile Icon Default" className="rounded-circle" style={{ cursor:"pointer", objectFit:"cover", width:"3.75rem", height:"3.75rem" }}/>
                          ) : (
